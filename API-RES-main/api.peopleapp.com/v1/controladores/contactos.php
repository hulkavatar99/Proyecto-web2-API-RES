...
class contactos
{
     ...
     * @throws Exception
     */
    private static function obtenerContactos($idUsuario, $idContacto = NULL)
    {
        try {
            if (!$idContacto) {
     ...
     * @throws ExcepcionApi
     */
    private static function crear($idUsuario, $contacto)
    {
        if ($contacto) {
            try {
     ...
     * @throws Exception
     */
    private static function actualizar($idUsuario, $contacto, $idContacto)
    {
        try {
     ...
     */
    private static function eliminar($idUsuario, $idContacto)
    {
        try {
            // Sentencia DELETE
